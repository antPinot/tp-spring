...
public class Animal {
	...
	// @JoinTable(name = "person_animals", joinColumns = @JoinColumn(name =
	// "animals_id", referencedColumnName = "id"), inverseJoinColumns =
	...
	/*
	 * @Override public String toString() { return "Animal [id=" + id + ", color=" +
	 * color + ", name=" + name + ", sex=" + sex + ", specie=" + specie +
	 * ", persons=" + persons + "]"; }
	 * 
	 */
