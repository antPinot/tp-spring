...
public interface PersonRepository extends JpaRepository<Person, Integer> , PersonRepositoryCustom{
	...
	public List<Person> findBetweenMinAgeAndMaxAge(@Param("minAge") int minAge, @Param("maxAge")  int maxAge);
	
	@Query("SELECT DISTINCT p FROM Person p JOIN p.animals a WHERE a = :animal")
	public List<Person> findAllPersonsByAnimal(@Param("animal") Animal animal);
